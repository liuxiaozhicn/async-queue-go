...
//		called := false
//		// ✅ 裸函数用 HandlerFunc 适配
//		handler := queue.HandlerFunc(func(ctx context.Context, m *Message) (Result, error) {
//			called = true
//			return ACK, nil
//		})
//
...
//
//		// ✅ 接口调用改为 .Handle()
//		_, _ = h.Handle(context.Background(), &core.Message{})
//		if !called {
...
//
//		count := 0
//		handler1 := HandlerFunc(func(ctx context.Context, m *Message) (Result, error) {
//			count = 1
//			return ACK, nil
//		})
//		handler2 := HandlerFunc(func(ctx context.Context, m *Message) (Result, error) {
//			count = 2
//			return ACK, nil
//		})
//
...
//		}
//		registry := NewServeMux()
//		registry.Register("disabled", HandlerFunc(func(ctx context.Context, m *Message) (Result, error) { // ✅
//			return ACK, nil
//		}))
//		manager, _ := NewManager(cfg, registry)
//
...
//		for i := 0; i < 10; i++ {
//			go func() {
//				registry.Register("test", HandlerFunc(func(ctx context.Context, m *Message) (Result, error) { // ✅
//					return ACK, nil
//				}))
//				done <- true
//			}()
